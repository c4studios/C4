...
export const CASE_STUDIES = {
  ...
  'quotr': {
    ...
    timeline: '',
    budget: '',
    role: 'C4 Studios Original',
    liveUrl: 'https://quotr.us',
    purchaseUrl: '/software#quotr',
    year: '2025',
    category: 'saas',
    status: 'Live',
    ...
    budgetOrder: 0,
    brandColor: '#050a1a',
    cover: '/Software/quotr-starter.jpeg',
    thumbnail: '/Software/quotr-starter.jpeg',
    logoUrl: '/Software/quotr-icon.jpeg',
    overview: 'Quotr lets service businesses embed a branded quote calculator on their website in under 5 minutes. Every quote comes with budget attached — so you know which leads are worth calling back.',
    screenshots: [],
    desktopScreenshots: [],
    mobileScreenshots: [],
    delivered: [],
  ...
  'returndesk': {
    ...
    purchaseUrl: '/software#returndesk',
    year: '2025',
    category: 'saas',
    status: 'Beta',
    tags: ['AI & Software', 'SaaS', 'Next.js'],
    ...
    budgetOrder: 0,
    brandColor: null,
    cover: '/Software/ReturnDesk.png',
    thumbnail: '/Software/ReturnDesk.png',
    logoUrl: '/Software/ReturnDesk.png',
    logoUrlMinimal: '/Software/returndesk-minimal.png',
    overview: 'ReturnDesk helps a service business decide who needs a response first, why they are first, and what to say. Manual-first, explainable, works on day one.',
    screenshots: [],
    desktopScreenshots: [],
    mobileScreenshots: [],
    delivered: [],
  ...
  'reviewloop': {
    ...
    role: 'C4 Studios Original',
    liveUrl: null,
    purchaseUrl: '/software#reviewloop',
    year: '2025',
    category: 'saas',
    status: 'Coming Soon',
    ...
    budgetOrder: 0,
    brandColor: null,
    cover: '/Software/ReviewLoop.png',
    thumbnail: '/Software/ReviewLoop.png',
    logoUrl: '/Software/ReviewLoop.png',
    logoUrlMinimal: '/Software/reviewloop-minimal.png',
    overview: 'Send templated review requests to past customers at the right moment. ReviewLoop handles the follow-up so you don\'t have to.',
    screenshots: [],
    desktopScreenshots: [],
    mobileScreenshots: [],
    delivered: [],
  ...
  'complia': {
    ...
    budgetOrder: 0,
    brandColor: null,
    cover: '/Software/Complia.png',
    thumbnail: '/Software/Complia.png',
    logoUrl: '/Software/Complia.png',
    overview: 'BAS, super, ASIC annual review — tracked, prepared, and reminded. Complia keeps small Australian businesses on top of their compliance obligations without a bookkeeper on retainer.',
    screenshots: [],
    desktopScreenshots: [],
    mobileScreenshots: [],
    delivered: [],
  ...
  'firmflow': {
    ...
    role: 'C4 Studios Original',
    liveUrl: null,
    purchaseUrl: '/software#firmflow',
    year: '2025',
    category: 'saas',
    status: 'Coming Soon',
    tags: ['AI & Software', 'SaaS', 'AI'],
    featured: false,
    budgetOrder: 0,
    brandColor: null,
    cover: '/Software/FirmFlow.png',
    thumbnail: '/Software/FirmFlow.png',
    logoUrl: '/Software/FirmFlow.png',
    overview: 'Paste a source article or update, get LinkedIn posts, newsletters, video scripts, and client emails — all with built-in disclaimer controls for law firms, accountants, and advisors.',
    screenshots: [],
    desktopScreenshots: [],
    mobileScreenshots: [],
    delivered: [],
  ...
  'c4-command': {
    ...
    role: 'C4 Studios Original',
    liveUrl: null,
    purchaseUrl: '/software#c4-command',
    year: '2025',
    category: 'saas',
    status: 'Studio',
    tags: ['AI & Software', 'Desktop App', 'Tauri'],
    featured: false,
    budgetOrder: 0,
    brandColor: null,
    cover: '/Software/C4Command.png',
    thumbnail: '/Software/C4Command.png',
    logoUrl: '/Software/C4Command.png',
    overview: 'A native Mac and Windows app that syncs the live lead pipeline, monitors daily automations, tracks projects and invoices, and connects to local AI. Built for the studio, available to C4 clients.',
    screenshots: [],
    desktopScreenshots: [],
    mobileScreenshots: [],
    delivered: [],
