...
export const CASE_STUDIES = {
  ...
  'ds-racing-karts': {
    ...
    delivered: [
      ...
      'Custom "DSR Grand Prix" slot-car racing mini-game — 4,863 lines of hand-written Canvas 2D code with physics engine, AI opponent, 4 tracks, F1-style countdown, and mobile touch controls',
    ...
    features: [
      ...
      'Custom-built "DSR Grand Prix" slot-car racing mini-game — 4,863 lines of Canvas 2D code with curvature-based physics, 4-tier AI difficulty, 4 tracks including a "Campbelltown GP" local Easter egg, F1-style 5-light countdown with false start detection, persistent skid marks, and mobile touch controls',
    ...
    challenges: [
      ...
      'Mini-game development in production — Designing and building a 4,863-line Canvas 2D racing game with physics, AI, and multiple tracks that runs smoothly alongside a content-heavy e-commerce site, using useRef patterns to avoid React re-render overhead in the animation loop',
