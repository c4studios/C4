...
export const CASE_STUDIES = {
  ...
  'quotr': {
    slug: 'quotr',
    name: 'Quotr',
    oneLiner: 'An embeddable instant-quote calculator that turns a service business\'s pricing logic into qualified, budget-attached leads.',
    client: 'C4 Studios (own product)',
    location: 'Perth, WA',
    timeline: '',
    budget: '',
