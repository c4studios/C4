...
export default function PageHero({ pretitle, titleLines = [], description, children }) {
  return (
    <section className="pt-28 md:pt-36 pb-12 md:pb-16" style={{ backgroundColor: 'var(--c4-bg)' }}>
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        {/* No overline. A tracked label above the title is the eyebrow the
            house bans; the title carries itself. The `label` prop callers still
