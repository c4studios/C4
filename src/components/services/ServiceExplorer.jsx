...
const SERVICES = [
  ...
  },
  {
    key: 'sight',
    title: 'C4Sight',
    summary: 'Workplace AI training and workshops. Practical, hands-on sessions that teach your team to use AI safely in their actual roles, with their actual tools.',
    includes: [
      'Half-day and full-day workshops',
      'Hands-on from the first hour, on your real work',
      'A data-safety and responsible-use module every session',
      'Sector framing for office, schools and law firms',
      'A prompt pack and workflows your team keeps',
      'On-site in Perth, remote on request',
    ],
    forWho: 'Teams who want to use AI well, from office and business to schools and law firms.',
    outcome: 'A team that uses AI day to day, safely, and keeps using it the month after.',
