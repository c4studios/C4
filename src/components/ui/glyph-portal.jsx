 ...
 *
 * C4 copy: the TypeScript original (21st.dev) transcribed to JSX for this
 * Vite + React 18 codebase. Behaviour is unchanged; only the types are gone
 * and `inert` is written as an attribute string, which React 18 passes
 * through. The component fetches nothing: preload the face before mounting.
 */
