...
const LineSidebar = ({
  ...
  smoothing = 100,
  defaultActive = null,
  // C4 addition: optional controlled active index. When provided (not null/
  // undefined), it becomes the source of truth for the active item so an
  ...
  const handleClick = useCallback(
    (index, label) => {
      // Only self-manage active state when uncontrolled; a controlled parent
      // owns it (and will update via the activeIndex prop).
