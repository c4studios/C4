...
|----------|-------------|--------------------|
| `ALLOWED_ORIGIN` | The exact origin allowed by CORS headers (`scheme://domain`, no trailing slash). Must match the URL visitors use to access the site. | `https://c4studios.com.au` |
...
| `PUBLIC_BUCKET_URL` | Text env var | Public URL prefix for uploaded files, no trailing slash. Must point to a domain or R2.dev URL where the bucket contents are publicly accessible. | Example: `https://uploads.c4studios.com.au` |
